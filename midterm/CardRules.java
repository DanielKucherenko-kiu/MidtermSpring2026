/**
 * CardRules centralizes the current UNO-like card representation and rules.
 *
 * This class intentionally preserves the existing string card format:
 * R5, YS, BR, G+2, W, W4.
 */
public final class CardRules {
    ...
    static boolean isLegal(String card, String up, String calledColor) {
        ...
        if (!calledColor.equals("") && color(card).equals(calledColor)) {
            return true;
        }
